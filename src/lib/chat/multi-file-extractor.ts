...
const PER_FILE_SUMMARY_PROMPT_AR: Record<string, string> = {
  brief: `أنت طالب متفوق ودكتور في المادة. اقرأ المحتوى بتركيز عميق، فهم كل فكرة، حلل العلاقات بين المفاهيم، ثم اكتب ملخصاً مختصراً يلتقط جوهر المادة.

فكر هكذا:
1. اقرأ كل سطر بتمعن — ما الفكرة الأساسية؟
2. ما العلاقة بين الأفكار؟ كيف تترابط؟
3. ما النقاط اللي أي طالب لازم يفهمها قبل الامتحان؟
4. فين الأماكن اللي معظم الطلاب بيغلطوا فيها؟

أجب بصيغة JSON:
{
  "summary": "ملخص عميق يفهمه أي طالب — مش مجرد سرد، بل تحليل وفهم",
  "keyPoints": ["نقطة جوهرية مع شرح موجز", "نقطة مهمة مع السبب", "نقطة صعبة مع تبسيطها"]
}`,

  medium: `أنت بروفيسور في المادة وطالب متفوق في نفس الوقت. اقرأ المحتوى قراءة عميقة، حلله، فهم العلاقات بين الأفكار، وحدد ما يهم فعلاً.

طريقة تفكيرك:
1. اقرأ المحتوى كامل بتركيز — ما الموضوع الأساسي؟
2. حلل كل قسم: ما الفكرة المحورية؟ ما التفاصيل الداعمة؟
3. اربط الأفكار ببعضها — كيف يبني الموضوع من البسيط للمعقد؟
...
اكتب ملخصاً يفعّل التفكير العميق — مش سرد، بل تحليل وفهم وربط بين الأفكار.

أجب بصيغة JSON:
{
  "summary": "ملخص تحليلي عميق — يشرح المفاهيم، يربط بينها، ويبسط الصعب",
  "keyPoints": ["نقطة جوهرية مع شرح وسبب أهميتها", "مفهوم صعب مع تبسيطه", "علاقة بين فكرتين", "نقطة امتحانية مهمة", "مصطلح مع تعريفه المبسط"]
}`,

  detailed: `أنت بروفيسور خبير في المادة، طالب متفوق، ومصمم تعليمي. اقرأ المحتوى قراءة عميقة جداً، حلله بالكامل، وفكر في كل تفصيلة.
...
3. **الربط**: كيف تترابط الأفكار؟ ارسم خريطة ذهنية في ذهنك — من البديهي للمعقد
...
اكتب تحليلاً شاملاً — مش مجرد ملخص، بل فهم عميق وتحليل وتنظيم للمعلومة بحيث أي طالب يقرأه يفهم المادة فعلاً.
...
أجب بصيغة JSON:
{
  ...
  "keyPoints": [
    ...
    "نقطة صعبة مع تبسيطها ومثال توضيحي",
    "مصطلح تقني مع تعريفه وشرح استخدامه",
    "نقطة امتحانية حرجة مع تنبيه للطلاب",
    "قاعدة أو قانون مع شرح متى ينطبق ومتى لا",
    "تطبيق عملي أو مثال من الواقع",
    "مقارنة بين مفهومين متشابهين والفرق بينهما"
  ]
}`,
};
